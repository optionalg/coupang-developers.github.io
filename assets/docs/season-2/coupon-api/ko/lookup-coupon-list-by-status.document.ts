export const  lookupCouponListByStatusDocument = {
  ...
  sample: {
    endpoint: `https://api-gateway.coupang.com/v2/providers/fms/apis/api/v1/vendors/A00000001/coupons?page=1&size=5&status=APPLIED`,
    code: [
      {
        language: `http`,
        codeblock: null
    ...
    response: {
          ...
          "data": {
            ...
            "content": [
              {
                "contractId": 1,
                "promotionName": "테스트 쿠폰 생성 ",
                "couponId": 75,
                "status": "APPLIED",
                "maxDiscountPrice": 1000,
                "discount": 100.0,
                "startAt": "2017-08-01 00:00:00",
