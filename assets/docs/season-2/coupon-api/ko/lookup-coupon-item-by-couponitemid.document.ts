export const  lookupCouponItemByCouponitemidDocument = {
  note: ``,

  //don't modify documentInfo
  documentInfo: {
    category: `coupon-api`,   // input category ex) exchange-service-api
    id: `lookup-coupon-item-by-couponitemid`,           // use **dash** and *english*  ex) coupang-confirm-request-creation
    anchorId: `lookup_coupon_item_by_couponitemid`,
    name: `쿠폰아이템목록 쿠폰아이템아이디로 조회`,       // use display name, i will change 'translation key'
  ...
  apiInfo: {
    ...
    httpMethod: `GET`,
    path: `/v2/providers/fms/apis/api/v1/vendors/{vendorId}/coupons/{couponId}/items/{couponItemId}`,
    HMACPath: `/v2/providers/fms/apis/api/v1/vendors/{vendorId}/coupons/{couponId}/items/{couponItemId}`,
    _description: `현재 적용된 쿠폰아이템을 쿠폰아이템아이디로 조회하기 위한 API입니다.`,
    _relation: ``,
    _referenceInfo: ``,
    _warning: ``,
  },
  ...
  sample: {
    endpoint: `https://api-gateway.coupang.com/v2/providers/fms/apis/api/v1/vendors/A00000001/coupons/77/items/80984?type=couponItemId`,
    code: [
      {
        language: `http`,
        codeblock: null
