export const changeSaleStatusToStopByProduct = {
  ...
  documentInfo: {
    ...
    name: `상품 아이템별 판매 중지`,       // use display name, i will change 'translation key'
  ...
  apiInfo: {
    ...
    HMACPath: `/v2/providers/seller_api/apis/api/v1/marketplace/vendor-items/{vendorItemId}/sales/stop`,
