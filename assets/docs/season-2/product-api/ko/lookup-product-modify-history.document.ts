export const lookupProductModifyHistoryDocument = {
  ...
  apiInfo: {
    ...
    httpMethod: `GET`,
    path: `/v2/providers/seller_api/apis/api/v1/marketplace/seller-products/{sellerProductId}/histories`,
    HMACPath: `/v2/providers/seller_api/apis/api/v1/marketplace/seller-products/{sellerProductId}/histories`,
