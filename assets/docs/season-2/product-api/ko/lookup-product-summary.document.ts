export const lookupProductSummaryDocument = {
  ...
  apiInfo: {
    ...
    httpMethod: `GET`,
    path: `/v2/providers/seller_api/apis/api/v1/marketplace/seller-products/external-vendor-sku-codes/{externalVendorSkuCode}`,
    HMACPath: `/v2/providers/seller_api/apis/api/v1/marketplace/seller-products/external-vendor-sku-codes/{externalVendorSkuCode}`,
    _description: `상품등록시 판매자가 입력한 판매자 상품코드(externalVendorSku)로 상품 요약 정보를 조회할 수 있다.`,
    _relation: ``,
    _referenceInfo: ``,
    _warning: ``,
  },
