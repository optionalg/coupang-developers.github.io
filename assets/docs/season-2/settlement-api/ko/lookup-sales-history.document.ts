...
(default = 50, min = 1, max = 50)`,
  ...
  sample: {
    endpoint: `https://api-gateway.coupang.com/v2/providers/openapi/apis/api/v4/vendors/{vendorId}/orders/salesDetails?recognitionDate=2016-12-30&nextToken=1&maxPerPage=20`,
    code: [
      {
        language: `http`,
        codeblock: null
