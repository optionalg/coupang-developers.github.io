export const lookupReturnRequestListPerMinuteDocument = {
  ...
  sample: {
    endpoint: `https://api-gateway.coupang.com/v2/providers/openapi/apis/api/v4/vendors/A00012697/returnRequests?searchType=timeFrame&createdAtFrom=2016-03-25T12:05&createdAtTo=2016-03-25T13:59&status=UC`,
    code: [
      {
        language: `http`,
      }
