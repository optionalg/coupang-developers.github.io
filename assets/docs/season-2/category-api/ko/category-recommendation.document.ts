...
부정확한 정보 입력 시 정확한 카테고리가 추천되지 않을 수 있습니다.<br/><br/>`,
...
쿠팡 카테고리 추천 API는 먼저, 입력된 정보에 가장 가까운 대분류 카테고리인 “생활용품”을 찾습니다. 이후 그 하위 카테고리인 “세제”를 찾고 내부적으로 계속 알맞은 하위 카테고리를 찾아 최종적으로 “생활용품>세제>세탁세제>표백제>분말형” 카테고리를 제안합니다.
<br/><br/>
    <table class="table">
        <tr>
            <th>입력 정보</th>
...
패션 의류의 경우 최소한 여성용/남성용/남녀공용인지 상품명에 들어가 있는 것이 좋습니다. 또한 단순히 ‘라운드티셔츠'라는 키워드보다는 맨투맨 티셔츠인지, 후드 티셔츠인지, 긴소매인지 반소매인지 등의 정보를 상품명에 함께 입력한다면 보다 정확한 카테고리 분류를 도와줄 수 있습니다.<br/>
...
사람이 상품명을 보아도 어떤 상품인지 예측이 쉽지 않은 위와 같은 경우는 쿠팡 카테고리 추천 API에서도 정확하게 제안할 수가 없습니다. 딜 형식으로 상품명을 등록하지 않도록 주의해주시고, 검색 키워드와 상품명을 구분하여 정확한 상품명을 입력해주시기 바랍니다. <br/>
