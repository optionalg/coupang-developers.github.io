export const lookupCategoryMetaInfoUseIdDocument = {
  ...
  apiInfo: {
    ...
    httpMethod: `GET`,
    path: `/v2/providers/seller_api/apis/api/v1/marketplace/meta/categories/{categoryId}`,
    HMACPath: `/v2/providers/seller_api/apis/api/v1/marketplace/meta/categories/{categoryId}`,
