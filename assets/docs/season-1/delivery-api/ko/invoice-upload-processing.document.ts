export const invoiceUploadProcessingDocument = {
  ...
  apiInfo: {
    ...
    HMACPath: `/v2/providers/wing_api/apis/internal-api/v2/ordersheets/invoices`,
  ...
  sample: {
    endpoint: `https://api-gateway.coupang.com/v2/providers/wing_api/apis/internal-api/v2/ordersheets/invoices`,
    code: [
      {
        language: `http`,
        codeblock: {
