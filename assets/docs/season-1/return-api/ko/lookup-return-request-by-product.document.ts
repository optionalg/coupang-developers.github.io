export const lookupReturnByProductDocument = {
  ...
  apiInfo: {
    ...
    HMACPath: `/v2/providers/wing_api/apis/internal-api/v1/return/{receiptId}`,
  ...
  sample: {
    endpoint:'https://api-gateway.coupang.com/v2/providers/wing_api/apis/internal-api/v1/return/363585',
    code: [
      {
        language: `http`,
        codeblock: {
