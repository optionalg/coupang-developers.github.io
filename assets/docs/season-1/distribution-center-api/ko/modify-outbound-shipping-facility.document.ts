export const modifyOutboundShippingFacilityDocument = {
  ...
  apiInfo: {
    ...
    HMACPath: `/v2/providers/wing_api/apis/internal-api/v1/product/outbound/shipping-places/{outboundShippingPlaceCode}`,
...
삭제하신다변, "false"로 설정.`,
  ...
  sample: {
    endpoint:`https://api-gateway.coupang.com/v2/providers/wing_api/apis/internal-api/v1/product/outbound/shipping-places/{outboundShippingPlaceCode}`,
    code: [
      {
        language: `http`,
        codeblock:{
